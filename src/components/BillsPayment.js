  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex flex-grow">
        ...
        <div className={`main-content p-6 mx-auto flex flex-col items-center justify-center w-full pt-16 ${isSidebarOpen ? 'sm:ml-5 md:mr-16 lg:mr-32' : 'sm:ml-5 md:mr-5 lg:mr-32'}`}>
