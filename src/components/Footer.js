            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/4 mb-6 sm:mb-0">
                        <h6 className="text-xl font-bold mb-2">Categorias</h6>
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/4">
                        ...
                        <ul className="space-y-2">
                            <li><a href="http://scanfcode.com/about/" className="text-gray-400 hover:text-white">Muestro equipo</a></li>
                            ...
                            <li><a href="http://scanfcode.com/privacy-policy/" className="text-gray-400 hover:text-white">Politicas de privacidad</a></li>
                        </ul>
                    </div>
                </div>
