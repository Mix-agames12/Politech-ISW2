  ...
  return (
    <div className="min-h-screen flex flex-col pt-16">
      ...
      <div className="flex flex-grow">
        ...
        <div className={`main-content p-5 mx-auto flex flex-col items-center justify-center w-full ${isSidebarOpen ? 'lg:ml-72 md:ml-48 sm:ml-32' : 'lg:mr-96 md:mr-64 sm:mr-32'}`}>
          <h2 className="text-2xl font-bold mb-4 text-center align-middle">Mis Productos</h2>
          <button className="bg-sky-900 text-white font-semibold py-2 px-4 rounded mb-4 hover:bg-sky-600 transition-colors duration-300 md:text-center md:align-middle sm:text-center sm:align-middle" onClick={handleCreateAccountClick}>
            Agregar Cuenta
          </button>
          <div className="lg:w-10/12 md:w-8/12 sm:w-7/12 space-y-8">
