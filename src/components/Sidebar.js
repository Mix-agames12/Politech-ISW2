...
export const Sidebar = () => {
  return (
    <>
      ...
      <aside id="default-sidebar" className="fixed top-16 left-0 z-40 w-60 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 pt-8 mb-6 flex flex-col overflow-y-auto bg-sky-50 dark:bg-gray-800">
            <ul className="space-y-4 font-medium">
              ...
              <li>
                  ...
                  <svg className="w-5 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
